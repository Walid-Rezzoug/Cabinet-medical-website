...
<?php echo "<a href='ModifierPRP.php?id={$row['ID']}'><button type='button' class='button1'>Edit</button></a>"; ?>
...
<?php
    ...
    echo "<h3>Error while searching the id <a href='dashboardP.php'>Back</a></h3>";
}
