...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        function genererCalendrier($mois, $annee,$id,$idr) {
            ...
            $idr = $_GET['idr'];
            echo "<a href='?mois=" . ($mois == 1 ? 12 : $mois - 1) . "&annee=" . ($mois == 1 ? $annee - 1 : $annee) . "&id=$id&idr=$idr' class='fleche-moitie fleche-gauche-moitie'>&lt;</a>";
            echo "<div class='mois-annee-moitie'>" . date('M', strtotime("$annee-$mois-01")) . " " . $annee . "</div>";
            echo "<a href='?mois=" . ($mois == 12 ? 1 : $mois + 1) . "&annee=" . ($mois == 12 ? $annee + 1 : $annee) . "&id=$id&idr=$idr' class='fleche-moitie fleche-droite-moitie'>&gt;</a>";
            echo "</div>";
            ...
            for ($jour = 1; $jour <= $nombreJoursDansMois; $jour++) {
                ...
                $boutonContenu = $estJourPasse ? "<div class='bouton-rond-moitie desactive-moitie'>$jour</div>" : "<a href='modif1.php?annee=$annee&mois=$mois&jour=$jour&id=$id&idr=$idr' class='bouton-rond-moitie' onclick='afficherDate(this, $jour, $mois, $annee)'>$jour</a>";
...
.bouton-rond-moitie.desactive-moitie {
    ...
    <div class="container2">
        ...
        genererCalendrier($moisAffiche, $anneeAffiche,$id,$idr);
            ?>
    </div>
...
<?php
    ...
    echo "<h3>Error while searching the id <a href='../cnxstaff/index.html'>Back</a></h3></script>";
}
$conn->close();
?>