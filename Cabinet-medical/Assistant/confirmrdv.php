...
if ($heure && $annee && $mois && $jour) {
    ...
    echo "<form method='post' action='updaterdv.php?id=$id&idp=$idp'>";
    ...
    echo "<a href='nvrdv1.php?id=$id&idp=$idp' class='button'> Annuler</a>";
    echo "</form>";
} else {
    echo "<p>Erreur : Informations de rendez-vous manquantes.</p>";
    echo "<a href='rendez-vouz.php?id=$id'>Retour</a>";
}
?>
