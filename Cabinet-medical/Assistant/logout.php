...
<body>
    <div class="container">
        ...
        <a href="../php/confirmlogoutA.php"><button class="confirm" type=button>me déconnecter</button></a>
        <?php echo "<a href='profilA.php?id={$row['ID']}'><button class='cancel' type=button>Annuler</button></a>"?>
    </div>
</body>
</html>
<?php
