...
button:hover {
    background-color: #2a7d2e; /* Vert foncé */
}
select {
...
select:focus {
  border-color:rgb(5, 165, 83);/* Change la couleur de la bordure au focus */
  outline: none; /* Supprime l'outline par défaut du navigateur */
  box-shadow: 0 0 5px rgb(1, 98, 48); /* Ajoute une ombre légère au focus */
}
...
select option:hover {
  background-color: #eee;
    ...
    <div class="container">
        ...
        <form action="nvrdv.php?id=<?php echo $id ?>" method="POST">
        ...
        <a href="rendez-vous.php?id=<?php echo $id?>" type="button"><button>Retour</button></a>
    </div>
