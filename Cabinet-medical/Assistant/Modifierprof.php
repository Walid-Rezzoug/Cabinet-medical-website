        ...
        <html>
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <form action="Modifierprof.php?id=<?php echo $id; ?>" method="POST">
                        ...
                        <input type="tel" id="heure" name="phone" value="<?php echo $row['tel']; ?>" required>

                        <label for="heure">Adresse e-mail :</label>
                        <input type="email" id="email" name="email" value="<?php echo $row['email']; ?>" readonly>

                        <label for="adresse">Adresse :</label>
                        <input type="text" id="adresse" name="addr" value="<?php echo $row['adresse']; ?>" required>
                        ...
                        <a href="profilA.php?id=<?php echo $id; ?>"><button type="button" class="cancelbtn">Annuler</button></a>
                    </form>
                </div>
            </body>
        </html>
