...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($stmt->execute()) {
        ...
        header("Refresh: 5; URL=patient.php?id=$id"); // Redirect after 5 seconds
...
<form method="POST" action="addnewP.php?id=<?php echo $id; ?>">
  ...
  <div class="container" style="background-color: rgb(255, 255, 255);">
    <a href="patient.php?id=<?php echo $id; ?>"><button  type=button class=cancelbtn>Cancel</button></a>
  </div>
</form>
<style>
    /* 🌿 Styles généraux */
